...
var Value = (0, _createReactClass2['default'])({
	...
	renderRemoveIcon: function renderRemoveIcon() {
		...
		renderRemoveIcon2: function renderRemoveIcon() {
		if (this.props.disabled || !this.props.onRemove) return;
		return _react2['default'].createElement(
			'div',
			{ className: 'Select-value-icon',
	...
	renderLabel: function renderLabel() {
		...
		return this.props.onClick || this.props.value.href ? _react2['default'].createElement(
			...
			'Series : '+this.props.children[0].split('-')[0]
		);
	},
	renderLabel2: function renderLabel2() {
		var className = 'Select-value-label';
		...
		return this.props.onClick || this.props.value.href ? _react2['default'].createElement(
			...
			'div',
			{ className: className, role: 'option', 'aria-selected': 'true', id: this.props.id },
			'Model : '+this.props.children[0].split('-')[1]
		);
	},
	...
	render: function render() {
		return _react2['default'].createElement(
			'div',
			{ className: (0, _classnames2['default'])('Select-value-custom', this.props.value.className),
				style: this.props.value.style,
				title: this.props.value.title
			},
			this.renderRemoveIcon(),
			this.renderLabel(),
			this.renderRemoveIcon2(),
			this.renderLabel2()
		);
	}
